...
if( !$search_text )
	$search_text = esc_attr( 'Search &hellip;', 'charitypure' );
?>
<form method="get"  id="searchform" class="navbar-search" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	<span class="search-query-container"><input type="text" class="search-query input-medium" name="s" placeholder="<?php echo $search_text; ?>" /><span>
</form>
<div class="clear"></div>
