...
function cyberchimps_options_help_text() {
	...
	$text .= '<div class="cc_help_section">
						<div class="row"><div class="col-md-3">
							<a href="' . apply_filters( 'cyberchimps_documentation', esc_url(__('http://cyberchimps.com','cyberchimps_core')) ) . '" title="CyberChimps Instructions">
								<img src="' . $instruction_img . '" alt="'.esc_attr__('CyberChimps Instructions', 'cyberchimps_core').'" />
								<div class="cc_help_caption"><p>' . __( 'Instructions', 'cyberchimps_core' ) . '</p></div>
							</a>
						</div>
						<div class="col-md-3">
							<a href="' . apply_filters( 'cyberchimps_support_forum', esc_url(__('http://cyberchimps.com','cyberchimps_core')) ) . '" title="CyberChimps Support">
								<img src="' . $support_img . '" alt="'.esc_attr__('CyberChimps Help', 'cyberchimps_core').'" />
...
// Filter to fetch list of posts
add_filter( 'cyberchimps_post_categories_list', 'cyberchimps_post_categories_list_func' );
function cyberchimps_post_categories_list_func( $options_categories ) {
