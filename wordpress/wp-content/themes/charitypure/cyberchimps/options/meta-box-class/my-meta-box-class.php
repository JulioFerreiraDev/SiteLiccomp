...
//              TODO able to work with this
		...
		public function show_field_repeater( $field, $meta ) {
			...
			if( count( $meta ) > 0 && is_array( $meta ) ) {
				foreach( $meta as $me ) {
					...
					echo '</table>';
					if( $field['sortable'] ) {
						echo '<span class="re-control"><img src="' . $plugin_path . '/images/move.png" alt="'.esc_attr__('sort','cyberchimps_core').'" title="'.esc_attr__('sort','cyberchimps_core').'" class="at_re_sort_handle" /></span>';
					}

					echo '
        <span class="re-control at-re-toggle"><img src="' . $plugin_path . '/images/edit.png" alt="'.esc_attr__('Edit','cyberchimps_core').'" title="'.esc_attr__('Edit','cyberchimps_core').'"/></span> 
        <span class="re-control"><img src="' . $plugin_path . '/images/remove.png" alt="' . esc_attr__( 'Remove', 'cyberchimps_core' ) . '" title="' . esc_attr__( 'Remove', 'cyberchimps_core' ) . '" id="remove-' . $field['id'] . '"></span>
        <span class="re-control-clear"></span></div>';
			...
			echo '" alt="' . esc_attr__( 'Add', 'cyberchimps_core' ) . '" title="' . esc_attr__( 'Add', 'cyberchimps_core' ) . '" id="add-' . $field['id'] . '"><br/></div>';
			...
			echo '</table><img src="' . $plugin_path . '/images/remove.png" alt="' . esc_attr__( 'Remove', 'cyberchimps_core' ) . '" title="' . esc_attr__( 'Remove', 'cyberchimps_core' ) . '" id="remove-' . $field['id'] . '"></div>';
...
class CyberChimps_Meta_Box extends AT_Meta_Box {
	...
	public function show_field_reorder( $field, $meta ) {
		$this->show_field_begin( $field, $meta );
		echo "Install the <a href='".esc_url(__('http://wordpress.org/extend/plugins/post-types-order/','cyberchimps_core'))."' target='_blank'>Post Types Order Plugin</a> to control the order of your custom slides.</td>";
