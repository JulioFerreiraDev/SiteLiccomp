...
if( is_admin() ) {
	...
	$pagedocs      = apply_filters( 'cyberchimps_page_options_help', esc_url(__('http://cyberchimps.com/guide/how-to-use-the-page-or-post-page-element/','cyberchimps_core')) );
	...
	$fields = array( array(
		...
		array(
			...
			'help_text' => '<a href="' . $pagedocs . '" target="_blank">' . sprintf( __( 'Visit the %s page options guide', 'cyberchimps_core' ), $themenamefull ) . '<span class="screen-reader-text">'. __('Page options guide (will open in a new window)', 'cyberchimps_core').'</span></a></td>'
		)
	);
	/*
